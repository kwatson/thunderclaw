...
export function prepareOpenClawUpgrade(options: { root: string; baseline: UpgradePreflight; preflight: UpgradePreflight; lockfileMode?: "update" | "verify"; generatedLockfileContents?: string; preparedDate?: string }): Promise<Record<string, unknown>>;
