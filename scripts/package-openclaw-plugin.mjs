...
const allowed = /^(?:package\/(?:LICENSE|NOTICE|README\.md|openclaw\.plugin\.json|package\.json)|package\/assets\/icon\.png|package\/dist\/(?:index|src\/[a-z0-9-]+)\.(?:js|d\.ts))$/u;
...
const archivedIcon = execFileSync("tar", ["-xOzf", archive, "package/assets/icon.png"]);
