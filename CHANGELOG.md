...
- Established the post-foundation trust anchor for automatic compatibility
  releases and isolated release-ledger tests from the mutable published pin.

## OpenClaw plugin [0.1.11] - 2026-09-23

### Changed

- Qualified the stable OpenClaw `2026.9.6` runtime and expanded bounded
  compatibility through the `2026.9.6` release line.

## OpenClaw plugin [0.1.10] - 2026-09-24

### Changed

- Added the manually reviewed foundation for unattended OpenClaw compatibility
  qualification and releases. The automation remains disabled until its
  repository and publisher controls are configured.

## OpenClaw plugin [0.1.9] - 2026-09-21

### Changed

- Qualified the stable OpenClaw `2026.9.5` runtime and expanded bounded
  compatibility through the `2026.9.5` release line.

## OpenClaw plugin [0.1.8] - 2026-09-10

### Changed

- Qualified the stable OpenClaw `2026.9.4` runtime and expanded bounded
  compatibility through the `2026.9.4` release line.
